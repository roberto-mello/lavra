...
/**
 * convert-opencode.ts
 * Converts beads-compound plugin files from Claude Code format to OpenCode format
 *
 * Security controls:
...
const OUTPUT_DIR = join(import.meta.dir, "../plugins/beads-compound/opencode");
 ...
 */
async function main() {
  console.log("🔄 Converting beads-compound to OpenCode format\n");
