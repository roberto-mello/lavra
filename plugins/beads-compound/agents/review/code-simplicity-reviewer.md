...
5. **Apply YAGNI Rigorously**:
   ...
   - Never flag `.beads/memory/` or `.beads/config/` files for removal -- these are beads-compound pipeline artifacts used as living knowledge documents and project configuration
