...
Report bugs encountered while using the beads-compound plugin. This command gathers structured information and creates a GitHub issue for the maintainer.
...
Issue: https://github.com/rbm/beads-compound-plugin/issues/[NUMBER]
Title: [beads-compound] Bug: [description]

Thank you for helping improve the beads-compound plugin!
