...
1. **Discover Available Skills**:
   - Use Glob to find all SKILL.md files: `**/**/SKILL.md` plus global skill dirs (for example `/skills/**/SKILL.md`)
   - Also check project-level skills: project skill directories (for example `<project-agent-dir>/skills/**/SKILL.md`)
