...
**Use slash command:** `triage command` for interactive approval workflow
...
| Trigger | Flow | Tool |
|---------|------|------|
| Code review | `workflow review command` → Findings → `triage command` → Todos | Review agent + skill |
