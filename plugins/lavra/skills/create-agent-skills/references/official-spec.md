...
| **Personal** | `~/.agent/skills/` | You, across all projects |
| **Project** | `<project-agent-dir>/skills/` | Anyone working in repository |
...
- **Project Skills**: Commit `<project-agent-dir>/skills/` to version control
