...
4. No valid command found: use direct user prompt. Do NOT let workers self-discover test commands.
...
Present plan once with direct user prompt including execution params:
