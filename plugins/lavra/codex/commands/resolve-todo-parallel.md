...
<guardrails>
If any todo recommends deleting, removing, or gitignoring files in `.lavra/memory/`, skip it and mark it as `wont_fix`. These are lavra-compound pipeline artifacts that are intentional and permanent.
</guardrails>
