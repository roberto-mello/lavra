...
**Usage:**
```bash
/lavra-compound                    # Document the most recent fix
/lavra-compound BD-007             # Document solution for specific bead
/lavra-compound [brief context]    # Provide additional context hint
```
...
**Related Commands:**
- `/lavra-plan` - Planning workflow (references documented knowledge)
- `/lavra-checkpoint` - Quick knowledge capture during work
- `/lavra-deepen` - Enhance plans with parallel research
</handoff>
