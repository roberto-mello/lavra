...
Use **direct user prompt**: "Would you like a quick simplicity review of the code changes?"
...
<handoff>
After the checkpoint report, use the **direct user prompt** to present next steps:
