...
`.lavra/config/codebase-profile.md` is generated by `/project-setup` Step 1.5 (brownfield codebase analysis) and committed to git. `/lavra-design` and `/lavra-work` read it as planning context.
