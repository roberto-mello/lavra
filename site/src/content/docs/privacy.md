...
- **Codebase profile** (`.lavra/config/codebase-profile.md`) — an optional analysis of your project's architecture generated by `/project-setup`. Stored in your project directory.
